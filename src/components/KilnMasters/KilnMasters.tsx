        ...
        <div className={styles.contentColumn}>
          ...
          <div className={styles.list}>
            <div className={styles.listItem}>
              ...
              <span className={`${styles.listText} font-headline-md`}>Generational Wisdom</span>
            </div>
            <div className={styles.listItem}>
              <span className={styles.number}>02</span>
              <span className={`${styles.listText} font-headline-md`}>Engineering Precision</span>
            </div>
            <div className={styles.listItem}>
              <span className={styles.number}>03</span>
              <span className={`${styles.listText} font-headline-md`}>Logistical Mastery</span>
            </div>
          </div>
        </div>
      </div>
