        ...
        <div className={styles.imageColumn}>
          <div className={styles.mainImageWrapper}>
            <img 
              ...
              alt="Close-up of Fare Face Gutka brick with deep red clay texture." 
            />
          </div>
          ...
          <div className={styles.thumbnailGrid}>
            <div className={styles.thumbnailWrapper}>
              <img 
                ...
                alt="Detailed macro shot showing the smooth clay finish." 
              />
            </div>
            <div className={styles.thumbnailWrapper}>
              <img 
                ...
                alt="Modern architectural facade featuring Fare Face Gutka bricks." 
              />
            </div>
            <div className={`${styles.thumbnailWrapper} ${styles.moreImages}`}>
              <img 
                ...
                alt="Construction site overview with pallets of high-quality red bricks." 
              />
              <div className={styles.moreOverlay}>
                <span className="font-label-caps">+5 More</span>
              </div>
            </div>
          </div>
        </div>
